...
class DeveloperSignUpViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var acceptNewsCheckBox: BEMCheckBox!
    @IBOutlet weak var termsLabelView: UIView!
    ...
    func initUI() {
        ...
        termsLabelView.addSubview(attributeLabel)
        
        let marginGuide = termsLabelView.layoutMarginsGuide
        
        attributeLabel.translatesAutoresizingMaskIntoConstraints = false
        let constraintLeading = attributeLabel.leadingAnchor.constraint(equalTo: termsLabelView.leadingAnchor)
        constraintLeading.constant = 40
        constraintLeading.isActive = true
        attributeLabel.centerYAnchor.constraint(equalTo: termsLabelView.centerYAnchor).isActive = true
